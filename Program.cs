...
Console.Write("Hello, This is Mad Libs. This is Mad Libs. When you are dong providing the requested words");
Console.Write("\n I will build them into a funny story for you");
Console.Write("\n Enter the requested word types"); // new line \n
Console.WriteLine();
...
and mothers sit around (verb ending in “ing”) Last summer, my little brother fell in a/an (noun) and got poison (plant) all over his (part of the body) My family is going to go to (place) 
and I will practice (verb ending in “ing”) Parents need vacations more than kids because parents are always very (adjective) and because they have to work
